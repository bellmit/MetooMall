...
public class EnoughReduce extends IdEntity {
	...
	private int erstatus;// 审核状态 -10为审核未通过 默认为0待审核 10为 审核通过 
							// 20为已结束。5为提交审核，此时商家不能再修改 30为活动已关闭
	...
	@Column(columnDefinition = "LongText")
	private String erbanner_goods_ids;// 活动精选商品id 
	...
	public String getErbanner_goods_ids() {
		return erbanner_goods_ids;
	}

	public void setErbanner_goods_ids(String erbanner_goods_ids) {
		this.erbanner_goods_ids = erbanner_goods_ids;
	}
