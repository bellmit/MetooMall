...
public class GoodsCart extends IdEntity {
	...
	private String cart_type;// 默认为空，组合销售时候为"combin"  0: 正常购物车 1：兑换商品 0元购 2：碎片兑换 3: 满级兑换
	private String cart_form;//购物车来源 web app
	...
	@Column(columnDefinition = "int default 0")
	private int cart_status;// 用户购物车状态，0表示没有提交为订单，1表示已经提交为订单，2表示已过期购物车 已经提交为订单信息的不再为缓存购物车，同时定时器也不进行删除操作
	...
	public String getCart_form() {
		return cart_form;
	}

	public void setCart_form(String cart_form) {
