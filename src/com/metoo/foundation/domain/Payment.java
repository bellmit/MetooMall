...
public class Payment extends IdEntity {
	...
	// 以下是百万支付信息
	private String api;// 支付API
	private String merchantNo;// 商户号 10072
	private String terminalNo;// 终端号 100001 
	private String url;// 支付URL https://xpt.baiwanpay.com/safety/pay
	private String returnURL;// 支付结果返回地址
	private String asynReturnURL;// 支付结果异步返回地址
	private String successURL;// 成功跳转地址
	private String failURL;// 失败跳转地址
	private String cancelURL;// 取消跳转地址
	private String language;// 语言 en_US
	private String currency;// 币种 USD
	private double exchange_rate;// 汇率
	private String card_type;//卡类型 VISA; Master; JCB; AE;
	private String shakey;// c4F7f2E2rl1JRkA
