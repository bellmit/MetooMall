...
public class CalendarTest {
	...
	public void testBean(){
		...
		/*ApplicationContext ac =new ClassPathXmlApplicationContext("applicationContext-configuration.xml");
		IUserService userService = (IUserService) ac.getBean(UserServiceImpl.class);*/
		
		/*IUserService userService = (IUserService) SpringUtil.getObject(IUserService.class);*/
		
		User user = userService.getObjById(Long.parseLong("2521"));
