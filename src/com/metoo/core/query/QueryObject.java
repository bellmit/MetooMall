...
public class QueryObject implements IQueryObject {
	...
	public IQueryObject addQueryOR(String field, SysMap para, String expression) {
		if (field != null && para != null) {
	...
	public IQueryObject addQuery(String field, String first,String second,
			String expression) {
		if (field != null && first != null && second != null) {
			queryString += " and " + field + " "
					+ handleExpression(expression) + " " + first + " and " + second;
		}
		return this;
	}
