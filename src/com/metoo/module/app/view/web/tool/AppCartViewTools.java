...
public class AppCartViewTools {
	 ...
	 * @decript 购物车商品
	 */
	public void cart_order(List map_list, String area_id, String user_id, Map cartMap, String language, Boolean voucher) {
	...
	public void cart_order_adjust(List map_list, String area_abbr, String area_id, String user_id, Map cartMap,
			String generalCouponId, String language, String integral, Boolean voucher) {
