...
import com.metoo.module.app.manage.buyer.v1.action.AppSearchKeywordAction;
...
public class AppSearchViewAction {
	...
	public void wapsearchV2(HttpServletRequest request, HttpServletResponse response, String gc_id, String currentPage,
		...
		try {
			response.getWriter().print(Json.toJson(new Result(0, "Suucessfully", map), JsonFormat.compact()));
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
